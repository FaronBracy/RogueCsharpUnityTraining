...
public class Player : Actor
{
    ...
    public void DrawInventoryA()
    {
        ...
        foreach (var trans in transforms)
        {
            ...
            {
                case "q":
                    DrawAbility(QAbility, trans, "Q");
                    break;
                case "w":
                    DrawAbility(WAbility, trans, "W");
                    break;
                case "e":
                    DrawAbility(EAbility, trans, "E");
                    break;
                case "r":
                    DrawAbility(RAbility, trans, "R");
                    break;
    ...
    private void DrawItem(IItem item, Text text,string name)
    {
